...
/* REQUIRES:
 *   p1, p2 point to Point objects
 * PROMISES:
 *   returns an object of Point that its x, y and z coordinates are the middle-
 *   point of those objects that p1, p2 are pointing to. The returned
